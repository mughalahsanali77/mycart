        ...
        try (PrintWriter out = response.getWriter()) {
          String email= request.getParameter("email");
           String password=  request.getParameter("password");
            ...
            UserDao userDao = new UserDao(FactoryProvider.getFactorty());
            User user=userDao.getUserByEmailAndPaaswor(email, password);
            ...
            if(user==null){
                ...
                if(user.getUserType().equals("admin")){
                    ...
                    out.println("we havenot identified user type");
                }
            }
        }
    }
